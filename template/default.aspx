...
<p>
    ...
    <%
            ...
            if (Request.Form["valider"] != null)
            {
                ...
                reseau_fly.Utilisateur unUtilisateur = new  reseau_fly.Utilisateur (nom, prenom, mail, mdp, pic);
            ...
            if (Request["action"] != null && Request["id_U"] != null) 
            {
                ...
                else if (Request["action"] == "e" && Request.Form["modifier"] != null) 
                {
                    ...
                    reseau_fly.Utilisateur unUtilisateur = new reseau_fly.Utilisateur (id_U, nom, prenom, mail, mdp, pic);
