<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inscription.aspx.cs" Inherits="reseau_fly.template.inscription" %>
                        ...
                        <div class="login-form">
                            <form id="form1" runat="server" method="post">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="Nom" runat="server" placeholder=" . . . "></asp:TextBox>  
                                </div>
                                <div class="form-group">
                                    <label>Votre prénom : </label>
                                    <asp:TextBox ID="Prenom" runat="server" placeholder=" . . . "></asp:TextBox>  
                                </div>
                                <div class="form-group">
                            ...
                            <div class="register-link">
                                <p>
                                    Déjà inscrit ?
                                    <a href="login.aspx">Connectez-vous !</a>
                                </p>
                            </div>
                        </div>
                    </div>
